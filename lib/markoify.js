...
/*
function __markoRequire(template) {
    template.viewEngine = 'marko';
    return template;
}
*/
var MARKO_REQUIRE_AST = {
        ...
        enter: function(node, parent) {
            if (node.type === 'CallExpression' &&
                ...
                if (ext === '.marko') {
                    ...
                    if (!addedMarkoRequire) {
                        ast.body.push(MARKO_REQUIRE_AST);
                        addedMarkoRequire = true;
                    }

                    node.callee.type = 'Identifier';
                    node.callee.name = '__markoRequire';
